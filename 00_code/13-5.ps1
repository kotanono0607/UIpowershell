function 13_5 {
    ...
    $フォーム.Text = "罫線設定"
    $フォーム.Size = New-Object System.Drawing.Size(520, 390)
    ...
    $OKボタン.Text = "OK"
    $OKボタン.Location = New-Object System.Drawing.Point(300, 310)
    $OKボタン.Size = New-Object System.Drawing.Size(90, 30)
    $OKボタン.DialogResult = [System.Windows.Forms.DialogResult]::OK

    $キャンセルボタン = New-Object System.Windows.Forms.Button
    $キャンセルボタン.Text = "キャンセル"
    $キャンセルボタン.Location = New-Object System.Drawing.Point(400, 310)
    $キャンセルボタン.Size = New-Object System.Drawing.Size(90, 30)
    $キャンセルボタン.DialogResult = [System.Windows.Forms.DialogResult]::Cancel

    $フォーム.Controls.AddRange(@($ラベル1, $chkPathVar, $パステキスト, $cmbPathVar, $参照ボタン, $ラベル2, $シートテキスト, $ラベル3, $セルテキスト, $ラベル4, $線種コンボ, $ラベル5, $位置コンボ, $OKボタン, $キャンセルボタン))
    ...
    $entryString = @"
# 罫線設定: $セル範囲
Excel操作_罫線設定 -ファイルパス $パスパラメータ -セル範囲 "$セル範囲" -線種 "$線種" -位置 "$位置"$シートパラメータ
"@
