function 13_3 {
    ...
    $フォーム.Controls.AddRange(@($ラベル1, $chkPathVar, $パステキスト, $cmbPathVar, $参照ボタン, $ラベル2, $シートテキスト, $ラベル3, $セルテキスト, $ラベル4, $色コンボ, $色選択ボタン, $OKボタン, $キャンセルボタン))
    ...
    $entryString = @"
# 背景色設定: $セル範囲 を $色 に
Excel操作_背景色設定 -ファイルパス $パスパラメータ -セル範囲 "$セル範囲" -色 "$色"$シートパラメータ
"@
