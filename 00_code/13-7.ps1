﻿function 13_7 {
    ...
    $フォーム.Text = "シート追加"
    $フォーム.Size = New-Object System.Drawing.Size(520, 260)
    ...
    $OKボタン.Text = "OK"
    $OKボタン.Location = New-Object System.Drawing.Point(300, 180)
    $OKボタン.Size = New-Object System.Drawing.Size(90, 30)
    $OKボタン.DialogResult = [System.Windows.Forms.DialogResult]::OK

    $キャンセルボタン = New-Object System.Windows.Forms.Button
    $キャンセルボタン.Text = "キャンセル"
    $キャンセルボタン.Location = New-Object System.Drawing.Point(400, 180)
    $キャンセルボタン.Size = New-Object System.Drawing.Size(90, 30)
    $キャンセルボタン.DialogResult = [System.Windows.Forms.DialogResult]::Cancel

    $フォーム.Controls.AddRange(@($ラベル1, $chkPathVar, $パステキスト, $cmbPathVar, $参照ボタン, $ラベル2, $シートテキスト, $OKボタン, $キャンセルボタン))
    ...
    $entryString = @"
# シート追加: $新シート名
Excel操作_シート追加 -ファイルパス $パスパラメータ -新シート名 "$新シート名"
"@
